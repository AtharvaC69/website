        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <table class="table table-stripped">
                    ...
                    <tr>
                        <td>Date Of Birth</td>
                        <td><asp:TextBox ID="txtDOB" CssClass="form-control" runat="server"></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="ceDateofBirth" TargetControlID="txtDOB" PopupButtonID="txtDOB" PopupPosition="BottomLeft" Format="dd-MM-yyyy" runat="server" />
                        </td>
                        <td><asp:RequiredFieldValidator ID="rfvDob" runat="server"
                                ErrorMessage="Please enter your date of birth" ForeColor="Red" Display="Dynamic"
                                ControlToValidate="txtDOB"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td>Gender</td>
                        <td><asp:RadioButtonList ID="rdogenderList" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal">
                            <asp:ListItem Text="Male" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Female" Value="2"></asp:ListItem>
                            <asp:ListItem Text="Other" Value="3"></asp:ListItem>
                            </asp:RadioButtonList> </td>
                        <td><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                ErrorMessage="Please select your gender" ForeColor="Red" Display="Dynamic"
                                ControlToValidate="rdogenderList"></asp:RequiredFieldValidator></td>
                    </tr>
