<%@ Page Title="" Language="C#" MasterPageFile="~/Usermaster.Master" AutoEventWireup="true" CodeBehind="CategoryManagement.aspx.cs" Inherits="MedicineManagement.CategoryManagement" %>
    ...
    <div class="container">
        ...
        <table class="table table-stripped">
            <tr>
                <td>Category Name</td>
                <td>
                    <asp:TextBox ID="txtCategoryName" CssClass="form-control" runat="server" ></asp:TextBox></td>
            ...
            <tr>
                <td>Description</td>
                <td>
                    <asp:TextBox ID="txtDescription" CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox></td>
                <td>
